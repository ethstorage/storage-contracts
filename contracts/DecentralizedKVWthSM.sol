...
contract DecentralizedKVWithSM is StorageManager {
    ...
    function put(bytes32 key, bytes memory data) public payable {
        ...
        // call precompiled contract 'sstoragePisaPutRaw'
        putRaw(paddr.kvIdx,data);
    }
    ...
    function get(
        ...
        bytes memory data= getRaw( paddr.hash, paddr.kvIdx, off, len);
