...
def hashimoto(shard_id, data_size, shard_size_bits, nshard_bits, naccess, h0, data_list, idx_list=None):
    ...
    for i in range(naccess):
        ...
        mix = bytes(a ^ b for a, b in zip(mix, data_list[i]))
        print("i: {}, parent: {}, kv_idx: {}, mix_data: {}".format(i, parent, kv_idx, mix_data))
        # print(mix.hex())
